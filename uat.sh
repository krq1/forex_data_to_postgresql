...
PGPASSWORD=mlekomleko6 psql -U postgres -d db2018 -c "\copy realdeal (time, ask, bid) from '/root/pipeline/uat_stream/f_99.csv' delimiter ',' CSV"
PGPASSWORD=mlekomleko6 psql -U postgres -d db2018 -c "insert into realdeal select * from tmpp on conflict do nothing"

#psql -U postgres -d db2018 -c "delete from realdeal
